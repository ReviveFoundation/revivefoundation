...
export default function MyApp({ Component, pageProps }){
  return (<>
    <nav className="nav"><div><strong>Revive Foundation</strong></div>
      <div><Link href="/">Home</Link><Link href="/about">About</Link><Link href="/programs">Programs</Link><Link href="/partners">Partnerships</Link><Link href="/get-involved">Get Involved</Link><Link href="/contact">Contact</Link></div>
    </nav>
    <Component {...pageProps} />
