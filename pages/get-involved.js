export default function GetInvolved(){return (<main>
  <section className="hero"><h1>Partner Your Properties with Purpose</h1><p>Convert available or rehab-ready homes into transitional housing.</p></section>
  <section className="section container"><h2>Submit a Property</h2>
  ...
  <section className="section container"><h2>Sponsor a Home</h2>
  ...
  <section className="section container"><h2>Volunteer / Mentorship</h2>
